# API Exercise 16: Get AI Commit Metrics

**Objective:** Retrieve AI commit metrics showing how many lines of code were generated by AI (Tab completions and Agent edits) versus humans in your team's git commits.

**Time:** 10 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** Your leadership wants to measure the ROI of Cursor by tracking what percentage of code is AI-generated. You need to programmatically extract commit-level metrics showing AI contribution over time.
