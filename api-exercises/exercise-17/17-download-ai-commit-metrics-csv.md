# API Exercise 17: Download AI Commit Metrics CSV

**Objective:** Download AI commit metrics as CSV for large data extractions, enabling offline analysis in Excel, pandas, or other data tools.

**Time:** 10 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** Your data science team wants to analyze six months of AI code contribution trends. The JSON API paginates at 1000 records, but you need all data for historical analysis. The CSV endpoint streams unlimited records efficiently.
