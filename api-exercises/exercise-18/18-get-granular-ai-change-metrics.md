# API Exercise 18: Get Granular AI Change Metrics

**Objective:** Retrieve granular AI change events – individual acceptances of Tab completions and Agent edits – for detailed analysis of AI acceptance patterns.

**Time:** 10 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** You need to understand not just how many lines were committed, but how AI suggestions are being accepted at a granular level. Which file types see the most AI acceptance? What's the distribution between Tab completions and Agent edits?
