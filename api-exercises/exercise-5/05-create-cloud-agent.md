# API Exercise 5: Create a Cloud Agent

**Objective:** Programmatically create a Cloud Agent to perform a task (adding a README file) and capture the agent ID and run ID for monitoring.

**Time:** 10 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** Your CI/CD pipeline needs to automatically generate documentation for each release. Instead of manually creating Cloud Agents from the dashboard, you want to launch them programmatically as part of your release workflow.
