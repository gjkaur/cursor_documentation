# API Exercise 7: List and Download Artifacts

**Objective:** Retrieve and download artifacts (screenshots, logs, generated files) produced by a Cloud Agent after it completes its work.

**Time:** 15 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** A Cloud Agent has finished generating a report. You need to programmatically download the screenshots it captured and the log files it produced to attach to your CI/CD pipeline results.
