# API Exercise 13: Get Daily Active Users (DAU)

**Objective:** Track daily active user metrics for your team, including breakdowns by product (CLI, Cloud Agents, Bugbot).

**Time:** 10 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** Your team wants to measure adoption of Cursor across different products. You need to track how many developers are using the IDE vs CLI vs Cloud Agents vs Bugbot to identify adoption patterns and training needs.
