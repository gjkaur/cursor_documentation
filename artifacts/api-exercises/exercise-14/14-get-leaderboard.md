# API Exercise 14: Get Leaderboard

**Objective:** Retrieve a leaderboard of team members ranked by AI usage metrics, including Tab completions and Agent edits.

**Time:** 10 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** Your team wants to recognize top power users and identify who might need additional training. You need to generate a leaderboard showing who's using Tab completions most effectively and who's getting the most value from Agent edits.
