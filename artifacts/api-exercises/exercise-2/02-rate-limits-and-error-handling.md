# API Exercise 2: Rate Limits and Error Handling

**Objective:** Learn to handle API rate limits gracefully using exponential backoff and properly handle common error responses (401, 403, 404, 429, 500).

**Time:** 10 minutes

**Difficulty:** Beginner

**Real-World Scenario:** Your team has built an automated dashboard that polls Cursor APIs every minute. Suddenly, you start getting 429 errors. You need to implement proper rate limit handling so your dashboard remains stable and doesn't get blocked.
