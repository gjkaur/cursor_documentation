# API Exercise 20: Create a Webhook Endpoint

**Objective:** Create a webhook endpoint to receive automatic notifications when Cloud Agents complete or encounter errors.

**Time:** 15 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** Your team wants to receive Slack notifications whenever a Cloud Agent finishes a task. Instead of manually checking the dashboard, you'll build a webhook server that listens for completion events and sends alerts.
