# API Exercise 6: Stream Agent Responses

**Objective:** Stream real-time responses from a Cloud Agent using Server-Sent Events (SSE) to watch the agent work as it happens.

**Time:** 15 minutes

**Difficulty:** Intermediate

**Real-World Scenario:** You've launched a Cloud Agent to perform a complex task. Instead of waiting and wondering what's happening, you want to watch the agent's progress in real-time – seeing its thoughts, tool usage, and final output as they occur.
