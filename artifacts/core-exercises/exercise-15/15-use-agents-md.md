# Cursor Training – Exercise 15

## Use AGENTS.md

**Objective:** Use AGENTS.md – a simple markdown file – to provide project-level instructions that the Agent automatically reads and follows.
