...
**This folder:** Open `core-exercises/exercise-3/` in Cursor. A matching [`calculator.c`](calculator.c) is included here so this exercise stays in its own subfolder.
