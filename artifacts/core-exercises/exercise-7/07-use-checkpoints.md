# Cursor Training – Exercise 7

## Use Checkpoints

**Objective:** Use Cursor's automatic checkpoints to safely experiment with code changes and instantly undo mistakes.

**Time:** 10 minutes

**Setup:** Any code project (continue with `calculator.c` from previous exercises)

**This folder:** Open `core-exercises/exercise-7/` in Cursor. A matching [`calculator.c`](calculator.c) is included here so this exercise stays in its own subfolder.
