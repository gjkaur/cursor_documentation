...
A ready-to-use copy is at [`calculator.c`](../../core-exercises/exercise-1/calculator.c). Open `core-exercises/exercise-1/` (under `core-exercises` in this repo) in Cursor and work from there. Open the `exercise-1` folder (under `core-exercises` in this repo) in Cursor and work from there.
