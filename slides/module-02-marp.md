...
> Now that you've mastered essential Cursor workflows, **Module 3** covers using different models for different tasks, managing API keys, and optimizing cost vs. quality.
